...
// $list = array_merge($produtoRepository->opcoesAlmoco(), $produtoRepository->opcoesCafe());
...
<body>
  <main>
    ...
    <section class="container-table">
        ...
        <tbody>
          <?php foreach ($list as $data): ?>
            <tr>
              ...
              <td>
                <a class="botao-editar" href="editar-produto.php?id=<?= $data->getId() ?>">Editar</a>
              </td>
              <td>
      ...
      <form action="conteudo-pdf.php" method="post">
